...
int main() {
  ...
  ps.info[player_t{1}].resource = 1000;
  ps.info[player_t{1}].fuel = 500;
  ps.info[player_t{1}].destruct = 200;
  ps.info[player_t{1}].crystals = 50;
  ps.info[player_t{2}].explored = true;
  ps.info[player_t{2}].numsectsowned = 3;
  ps.info[player_t{2}].resource = 100;
  ps.info[player_t{2}].fuel = 50;
  ps.info[player_t{2}].destruct = 20;
  ps.info[player_t{2}].crystals = 5;
  Planet planet(ps);
