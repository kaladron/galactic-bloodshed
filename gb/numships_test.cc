...
int main() {
  ...
  strcpy(test_ship1.name, "TestShip1");
  ...
  strcpy(test_ship2.name, "TestShip2");
  ...
  strcpy(test_ship3.name, "TestShip3");
  ...
  assert(strcmp(retrieved_ship1.value().name, "TestShip1") == 0);
  ...
  assert(strcmp(retrieved_ship2.value().name, "TestShip2") == 0);
  ...
  assert(strcmp(retrieved_ship3.value().name, "TestShip3") == 0);
