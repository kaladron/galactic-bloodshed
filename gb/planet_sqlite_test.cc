...
int main() {
  ...
  assert(retrieved.info[1].est_production == test_planet.info[1].est_production);

  // Verify routes for player 1
  assert(retrieved.info[1].route[0].set == test_planet.info[1].route[0].set);
  assert(retrieved.info[1].route[0].dest_star == test_planet.info[1].route[0].dest_star);
  assert(retrieved.info[1].route[0].dest_planet == test_planet.info[1].route[0].dest_planet);
  assert(retrieved.info[1].route[0].load == test_planet.info[1].route[0].load);
  assert(retrieved.info[1].route[0].unload == test_planet.info[1].route[0].unload);
  ...
  assert(retrieved.info[1].route[1].dest_star == test_planet.info[1].route[1].dest_star);
  assert(retrieved.info[1].route[1].dest_planet == test_planet.info[1].route[1].dest_planet);
  assert(retrieved.info[1].route[1].load == test_planet.info[1].route[1].load);
  assert(retrieved.info[1].route[1].unload == test_planet.info[1].route[1].unload);
