...
int main() {
  ...
  bool saved = repo.save_sector(test_sector, test_planet.planet_id, 5, 7);
  ...
  auto retrieved = repo.find_sector(test_planet.planet_id, 5, 7);
  ...
  saved = repo.save_sector(*retrieved, test_planet.planet_id, 5, 7);
  ...
  auto updated = repo.find_sector(test_planet.planet_id, 5, 7);
  ...
  repo.save_sector(sector2, test_planet.planet_id, 3, 4);
  ...
  auto not_found = repo.find_sector(test_planet.planet_id, 99, 99);
  ...
  repo.save_sector(sector_p2, planet2.planet_id, 5, 7);

  // Both sectors should exist independently
  auto p1_sec = repo.find_sector(test_planet.planet_id, 5, 7);
  auto p2_sec = repo.find_sector(planet2.planet_id, 5, 7);
