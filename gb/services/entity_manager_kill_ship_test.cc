...
int main() {
  ...
  // Test 4: Morale adjustment for non-VN kills
  {
    ...
    // Note: We can't predict exact morale values without implementing adjust_morale,
    // but we can verify that the races were loaded and saved
  ...
  // Test 5: VN hitlist tracking
  {
    ...
    assert(universe_after->VN_index1[0] == 0 || universe_after->VN_index2[0] == 0);
