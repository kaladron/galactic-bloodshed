...
int main() {
  ...
  em.post_telegram(1, 1, "First telegram to player 1, governor 1\n");
  em.post_telegram(1, 1, "Second telegram to player 1, governor 1\n");
  em.post_telegram(1, 2, "Telegram to player 1, governor 2\n");
  em.post_telegram(2, 1, "Telegram to player 2, governor 1\n");
  ...
  test::expect_true(em.has_telegrams(1, 2));
  test::expect_true(em.has_telegrams(2, 1));
  test::expect_false(em.has_telegrams(3, 1));  // No telegrams for player 3
  test::expect_false(em.has_telegrams(1, 3));  // No telegrams for governor 3
  std::println(std::cout, "  ✓ has_telegrams() works correctly");

  // Retrieve telegrams
  std::println(std::cout, "\nTest 3: Retrieve telegrams");
  auto telegrams_p1g1 = em.get_telegrams(1, 1);
  test::expect_eq(telegrams_p1g1.size(), 2);
  test::expect_eq(telegrams_p1g1[0].message,
                  "First telegram to player 1, governor 1\n");
  test::expect_eq(telegrams_p1g1[1].message,
                  "Second telegram to player 1, governor 1\n");
  test::expect_eq(telegrams_p1g1[0].recipient_player, 1);
  test::expect_eq(telegrams_p1g1[0].recipient_governor, 1);
  std::println(std::cout, "  ✓ Retrieved 2 telegrams for player 1, governor 1");

  auto telegrams_p1g2 = em.get_telegrams(1, 2);
  test::expect_eq(telegrams_p1g2.size(), 1);
  test::expect_eq(telegrams_p1g2[0].message,
                  "Telegram to player 1, governor 2\n");
  std::println(std::cout, "  ✓ Retrieved 1 telegram for player 1, governor 2");

  auto telegrams_p2g1 = em.get_telegrams(2, 1);
  test::expect_eq(telegrams_p2g1.size(), 1);
  test::expect_eq(telegrams_p2g1[0].message,
                  "Telegram to player 2, governor 1\n");
  std::println(std::cout, "  ✓ Retrieved 1 telegram for player 2, governor 1");

  // Verify timestamps are set
  std::println(std::cout, "\nTest 4: Verify timestamps");
  for (const auto& telegram : telegrams_p1g1) {
  ...
  em.delete_telegrams(1, 1);
  test::expect_false(em.has_telegrams(1, 1));
  test::expect_true(
      em.has_telegrams(1, 2));  // Other governor still has telegrams
  test::expect_true(
      em.has_telegrams(2, 1));  // Other player still has telegrams
  std::println(std::cout, "  ✓ Deleted telegrams for player 1, governor 1");

  // Verify deletion
  std::println(std::cout, "\nTest 6: Verify deletion");
  auto after_delete = em.get_telegrams(1, 1);
  ...
  push_telegram(em, 3, 1, "Message via push_telegram\n");
  test::expect_true(em.has_telegrams(3, 1));
  auto telegrams_p3g1 = em.get_telegrams(3, 1);
  test::expect_eq(telegrams_p3g1.size(), 1);
  test::expect_eq(telegrams_p3g1[0].message, "Message via push_telegram\n");
  ...
  test::expect_false(em.has_telegrams(1, 2));
  test::expect_false(em.has_telegrams(2, 1));
  test::expect_false(em.has_telegrams(3, 1));
  test::expect_false(em.has_telegrams(4, 1));
  test::expect_false(em.has_telegrams(4, 2));
  test::expect_false(em.has_telegrams(4, 3));
  ...
  em.post_telegram(5, 1, special_msg);
  auto special_telegrams = em.get_telegrams(5, 1);
  ...
  long_msg += "\n";
  em.post_telegram(5, 2, long_msg);
  auto long_telegrams = em.get_telegrams(5, 2);
  ...
  em.post_telegram(6, 1, "");
  auto empty_telegrams = em.get_telegrams(6, 1);
  ...
  em.post_telegram(7, 1, "First\n");
  em.post_telegram(7, 1, "Second\n");
  em.post_telegram(7, 1, "Third\n");
  auto ordered_telegrams = em.get_telegrams(7, 1);
  ...
  em.post_telegram(8, 2, "Player 8, Gov 2\n");
  em.post_telegram(9, 1, "Player 9, Gov 1\n");

  auto p8g1_telegrams = em.get_telegrams(8, 1);
  auto p8g2_telegrams = em.get_telegrams(8, 2);
  auto p9g1_telegrams = em.get_telegrams(9, 1);

  test::expect_eq(p8g1_telegrams.size(), 1);
  test::expect_eq(p8g2_telegrams.size(), 1);
  test::expect_eq(p9g1_telegrams.size(), 1);
  test::expect_eq(p8g1_telegrams[0].message, "Player 8, Gov 1\n");
  test::expect_eq(p8g2_telegrams[0].message, "Player 8, Gov 2\n");
  test::expect_eq(p9g1_telegrams[0].message, "Player 9, Gov 1\n");
  ...
  em.delete_telegrams(8, 1);
  test::expect_false(em.has_telegrams(8, 1));
  test::expect_true(
      em.has_telegrams(8, 2));  // Different governor still has telegrams
  test::expect_true(
      em.has_telegrams(9, 1));  // Different player still has telegrams
  std::println(std::cout,
