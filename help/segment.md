SEGMENT                        Galactic Bloodsched	        	SEGMENT

CONCEPT: movement segment

	A movement segment (or a move seg) is a procedure during which the
...
percent reduced by some amount.
