...
extern int can_build_on_sector(int, racetype *, planettype *, sectortype *, 
	int, int, char *);
extern int build_at_ship(int, int, racetype *, shiptype *, int *, int *);
extern void autoload_at_planet(int, shiptype *, planettype *, sectortype *, int *,
			double *);
...
extern void create_ship_by_planet(int, int, racetype *, shiptype *, planettype *,
			   int, int, int, int);
extern void create_ship_by_ship(int, int, racetype *, int, startype *, planettype *,
			 shiptype *, shiptype *);
