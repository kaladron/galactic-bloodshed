...
extern int shoot_planet_to_ship(racetype *, planettype *, shiptype *, int,
				 char *, char *);
#endif
extern int shoot_ship_to_planet(shiptype *, planettype *, int, int, int, int, int,
				 int, char *, char *);
extern int do_radiation(shiptype *, double, int, int, char *, char *);
extern int do_damage(int, shiptype *, double, int, int, int, int, double, char *,
		      char *);
...
extern int Num_hits(double, int, int, double, int, int, int, int, int, int, int,
		     int);
extern int hit_odds(double, int *, double, int, int, int, int, int, int, int, int);
