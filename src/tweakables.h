...
/* 3.0 feature */
#define LIMITED_RESOURCES	1 /* set to 0 if you want unlimited resource
...
#define FUEL_USE 0.02		/* fuel use per ship mass pt. per speed
				   factor */
...
#define REPEAT_CHARACTER ' '	/* this character makes the previous command to
				   repeat */
